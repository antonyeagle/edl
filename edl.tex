...
\documentclass[openany,leqno,10pt]{book}
\usepackage{latexsym}
\usepackage{textcomp}
\usepackage{amsmath}
...
\usepackage[round,authoryear,sort]{natbib}
 	\bibpunct[:~]{(}{)}{;}{a}{,}{;~}
\usepackage[norule,bottom,multiple,splitrule,flushmargin]{footmisc}
\usepackage{prooftree}
\usepackage{qtree}
\usepackage{subfig}
\captionsetup[subfloat]{position=bottom,nearskip=6pt,farskip=6pt,captionskip=6pt}
\usepackage[all]{xy}
\usepackage{phonetic}
\usepackage{metalogo}
\usepackage{stmaryrd}
...
\newcommand{\sml}{\ensuremath{\mathcal{SML}}}

\newcommand{\val}[2]{\ensuremath{\left\llbracket #1\right\rrbracket_{\mathscr{#2}}}}
\newcommand{\vals}[3]{\ensuremath{\left\llbracket#1\right\rrbracket^{#3}_{\mathscr{#2}}}}
...
\fancyhead{}
\fancyhead[CE]{\textnormal{\textsc{\lowercase{Elements of Deductive Logic}}}}
\fancyhead[CO]{\textnormal{\textsc{\nouppercase{\rightmark}}}}
\cfoot{\thepage} 
...
% many-valued and relevance logic
...
\chapter[Mathematical Induction and Proof]{Mathematical Induction and The Notion of Proof}\label{c:induct} % c1
 \input{edl-induct.tex}

	\newpage
	\chapter{Set Theory}\label{c:sets} % c2
	 \input{edl-sets.tex}
		\newpage

\part{Sentential Logic: Language and Meaning} \label{p:l1}

\chapter{The Syntax of \texorpdfstring{$\mathcal{L}_{1}$}{L1}}\label{c:l1syntax} % c3
\input{edl-l1syntax.tex}	
\newpage

\chapter{The Semantics of \texorpdfstring{$\mathcal{L}_{1}$}{L1}}\label{c:l1semantics} % c3a
\input{edl-l1semantics.tex}  
\newpage

\chapter{Metatheory of \texorpdfstring{$\mathcal{L}_{1}$}{L1}}\label{c:l1meta} % c4
 \input{edl-l1meta.tex}

\part{Sentential Logic: Derivations} \label{p:l1deriv}

\chapter[Tableau Derivations in \texorpdfstring{$\mathcal{L}_{1}$}{L1}]{Tableau Derivations in \texorpdfstring{$\mathcal{L}_{1}$}{L1}}\label{c:l1tabl} % c5
  \input{edl-l1tabl.tex}

\chapter[Tableau Metatheory]{Tableau Metatheory: Soundness and Completeness}\label{c:tablmeta} % c5a
  \input{edl-tablmeta.tex}

\chapter[Natural Deduction in \texorpdfstring{$\mathcal{L}_{1}$}{L1}]{Natural Deduction Derivations in \texorpdfstring{$\mathcal{L}_{1}$}{L1}; Soundness and Completeness}\label{c:l1nd} % c5b
  \input{edl-l1nd.tex}

\chapter[Natural Deduction Metatheory]{Natural Deduction Metatheory: Soundness and Completeness}\label{c:ndmeta} % c5ab
 \input{edl-ndmeta.tex}

\part{Predicate Logic} \label{p:l2}


\chapter{The Syntax and Semantics of \texorpdfstring{$\mathcal{L}_{2}$}{L2}}\label{c:l2} % c6
 \input{edl-l2.tex}

\newpage

\chapter[Tableaux for \texorpdfstring{$\mathcal{L}_{2}$}{L2}]{Tableaux for \texorpdfstring{\ltwo}{L2}; Soundness}\label{c:l2tabl} % c7
% \input{edl-l2tabl.tex}

\chapter[Natural Deduction in \texorpdfstring{$\mathcal{L}_{2}$}{L2}]{Natural Deduction Derivations in \texorpdfstring{\ltwo}{L2}; Soundness}\label{c:l2nd} % c7
 \input{edl-l2nd.tex}

\chapter{Syntax, Semantics, and Derivations in \texorpdfstring{$\mathcal{L}_{=}$}{L=}}\label{c:lequals} % c8
 \input{edl-lequals.tex}
...
\chapter{Logic and Natural Language Conditionals}\label{c:cond} % c9
 \input{edl-cond.tex}

\chapter[Entailment, Designators, and Relations]{Logic and Natural Language: Entailment, Designators, and Relations}\label{c:edr} % c9
\input{edl-edr.tex}
...
\twocolumn
\chapter*{List of Definitions}\addcontentsline{toc}{chapter}{List of Definitions}\label{defns}
{\small  \listtheorems{definition}}

{\small\addcontentsline{toc}{chapter}{List of Tables}\label{listtable}
 \listoftables}

{\small\addcontentsline{toc}{chapter}{List of Figures}
\listoffigures}
...
\bibitem[{Edgington(2014)}]{edgington}
