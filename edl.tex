...
\documentclass[openany,leqno,11pt]{book}
\usepackage{latexsym}
\usepackage{textcomp}
\usepackage{amsmath}
...
\chapter{The Syntax of \texorpdfstring{$\mathcal{L}_{1}$}{L1}}\label{c3}
\input{edl-3.tex}	
\newpage

\chapter{The Semantics of \texorpdfstring{$\mathcal{L}_{1}$}{L1}}\label{c3a}
\input{edl-4.tex}  
\newpage

\chapter{Metatheory of \texorpdfstring{$\mathcal{L}_{1}$}{L1}}\label{c4}
 \input{edl-5.tex}

\newpage

\chapter[Natural Deduction in \texorpdfstring{\lone}{L1}]{Natural Deduction Proofs in \texorpdfstring{$\mathcal{L}_{1}$}{L1}; Soundness and Completeness}\label{c5}
  \input{edl-6.tex}

\newpage

\chapter{The Syntax and Semantics of \texorpdfstring{$\mathcal{L}_{2}$}{L2}}\label{c6}
 \input{edl-7.tex}

\newpage

\chapter[Natural Deduction in \texorpdfstring{\ltwo}{L2}]{Natural Deduction Proofs in \texorpdfstring{\ltwo}{L2}; Soundness}\label{c7}
 \input{edl-8.tex}

\chapter{Syntax, Semantics, and Proofs in \texorpdfstring{$\mathcal{L}_{=}$}{L=}}\label{c8}
 \input{edl-9.tex}
